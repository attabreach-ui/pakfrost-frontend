...
export const stockApi = {
  ...
  docStatus: (docNumber: string, type: 'IN' | 'OUT') =>
    client.get(`/stock/doc-status/${docNumber}`, { params: { type } }) as Promise<any>,
  voidIGP:    (number: string, reason: string) => client.post(`/stock/igp/${number}/void`, { reason }) as Promise<any>,
  restoreIGP: (number: string) => client.post(`/stock/igp/${number}/restore`) as Promise<any>,
  voidOGP:    (number: string, reason: string) => client.post(`/stock/ogp/${number}/void`, { reason }) as Promise<any>,
  restoreOGP: (number: string) => client.post(`/stock/ogp/${number}/restore`) as Promise<any>,
};
